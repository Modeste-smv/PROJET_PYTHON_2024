...
def process_expirations(symbols, min_date=None, max_date=None):
    ...
    for sym in symbols:
        ...
        for expiration_date in expirations_to_process:
            ...
            data['expiration_date'] = pd.to_datetime(data['expiration_date']).dt.date
...
data = process_expirations(["AAPL","MSFT","TSLA","JNJ","JPM","XOM","PG","NVDA"], min_date=None, max_date=None)
